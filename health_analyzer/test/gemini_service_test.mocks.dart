...
// in Lablens/test/gemini_service_test.dart.
...
import 'package:Lablens/services/gemini_model_wrapper.dart' as _i5;
...
class MockGenerativeModelWrapper extends _i1.Mock
    implements _i5.GenerativeModelWrapper {
  MockGenerativeModelWrapper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<String?> generateContentText(
    Iterable<_i6.Content>? content, {
    _i6.GenerationConfig? generationConfig,
    List<_i6.SafetySetting>? safetySettings,
    List<_i6.Tool>? tools,
    _i6.ToolConfig? toolConfig,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #generateContentText,
